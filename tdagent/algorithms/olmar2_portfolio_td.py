...
sys.path.append('E:/OANDA historical data/surf2017-forex-trading/surf2017/tdagent')
...
class TestStrategy(bt.Strategy):
	...
	def next(self):
		...
		b = self.decide_by_history(self.history, self.b)
		#print(b)
...
if __name__ == '__main__':
	...
	df = {}
	name = ['EUR_USD_NEW', 'GBP_USD_NEW', 'NZD_USD_NEW']
